...
## Usage
1. `python tags_spider.py --start 1 --end 5` to spider tags from page 1 to 5 in stackoverflow ranked by popularity.
   <div align="center">
      <img src="../res/img/spider-tags.jpg" width = "80%" alt="spider-tags" align=center />
    </div>
2. `python .\corenlp_chunk_candidate_relations_triples.py` to spider data from tags' page, preprocess text(resolve coreference) and chunk candidate relation triples
   <div align="center">
