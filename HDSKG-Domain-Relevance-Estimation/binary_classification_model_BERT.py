...
# store our model output and checkpoints
...
# input data is "merged_sentce" colums
...
print("Get tokenizer successfully...")
os.system("pause")
...
print("num of train steps is", num_train_steps)
os.system("pause")
...
def getPrediction(in_sentences):
  labels = ['T', 'F']
  input_examples = [run_classifier.InputExample(guid="", text_a = x, text_b = None, label = "T") for x in in_sentences] # here, "T" is just a dummy labelt
